                ...
                <div class="col-xxl-5 col-xl-5 col-lg-6 col-md-8">
                    <div class="about__content-3 pt-55">
                        <div class="section__title-wrapper section__title-wrapper-2 mb-55 wow fadeInUp" data-wow-delay=".3s">
                            ...
                            <p>With the most efficient team and comparative precises, We can assure you the best service and best prises in the market</p>
                        </div>
                        <a href="/contact" class="w-btn w-btn-blue w-btn-3 w-btn-1">Get Quotation</a>
                    </div>
                </div>
            </div>
        </div>
